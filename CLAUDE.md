# CLAUDE.md — Reusable Skill + No-Code Automation (HO6)
...
## About this project
A reusable Claude Skill plus a no-code automation playbook.
**Primary way to do it:** Claude Skills + Claude Cowork — **no API key needed.**
...
- It's the **Reusable Skill + No-Code Automation** hands-on. Subscription-native (Skills + Cowork) — no API key.
